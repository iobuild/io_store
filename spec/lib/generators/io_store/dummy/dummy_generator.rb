...
module IoStore
  class DummyGenerator < Rails::Generators::Base
    desc "Creates blank Rails application, installs io_store, and all sample data"
    ...
    def generate_test_dummy
      ...
      run "rails generate io_store:install --user-class=User --category-class=Category --no-migrate=true --current-user-helper=current_user"
    end
